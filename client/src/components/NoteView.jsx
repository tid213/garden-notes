...
function NoteView({noteID, closeButton, editButton}){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          const { error } = await supabase.from('notes').upsert([{id: noteID, note: editedNote}]);
          if (error) {
            throw error; 
          }
    ...
    return(
        <div className='w-screen'>
            ...
            <div onClick={handleSubmit}
                ...
                <img src={editImage} className='w-4 h-4' alt="edit note"></img>
            ...
            <div onClick={() => setShowConfirmation(true)}
                ...
                <img src={trashImage} className='w-4 h-4' alt="delete note"></img>
