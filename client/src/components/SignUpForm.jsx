...
const SignUpForm = () => {
  ...
  return (
    <div className=" inter max-w-sm mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className=" text-xl mb-8 text-gray-700">Create Account</h2>
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="w-full bg-lime-500 hover:bg-lime-600 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline"
          disabled={loading}
        >
